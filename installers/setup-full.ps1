...
Write-Host "PitLane - installation complete avec service Windows natif"
Write-Host "Lancement de l'installateur complet historique..."

$legacyInstaller = Join-Path $env:TEMP "pitlane-setup-full-legacy.ps1"
Invoke-WebRequest `
    -Uri "https://raw.githubusercontent.com/JeanBernardMagnien/pitlane-agent/$LegacyCommit/installers/setup-full.ps1" `
...
if (-not $AcEvoPath) {
    throw "AC EVO Dedicated Server introuvable apres installation complete."
}
...
[System.Windows.Forms.MessageBox]::Show(
    "Installation complete terminee.`nPitLane Agent est maintenant installe comme service Windows natif.`n`nVerification : Get-Service PitLaneAgent",
