...
Write-Host "Installation complete PitLane avec service Windows natif..."

& (Join-Path $PSScriptRoot "setup-full.ps1")
...
[System.Windows.Forms.MessageBox]::Show(
    "Installation complete terminee.`nPitLane Agent est installe comme service Windows natif.`n`nVerification : Get-Service PitLaneAgent",
